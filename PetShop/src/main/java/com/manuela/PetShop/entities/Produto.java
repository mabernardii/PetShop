...
public class Produto {
    ...
    private String petshopensina;
    
    public String getPetshopensina() {
        return petshopensina;
    }

    public void setPetshopensina(String petshopensina) {
        this.petshopensina = petshopensina;
    }
